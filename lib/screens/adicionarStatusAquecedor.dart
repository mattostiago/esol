...
class AdicionarStatusAquecedor extends StatefulWidget {
  const AdicionarStatusAquecedor({super.key});

  @override
  State<AdicionarStatusAquecedor> createState() =>
      _AdicionarStatusAquecedorState();
}

class _AdicionarStatusAquecedorState extends State<AdicionarStatusAquecedor> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Adicionar status aquecedor"),
      ),
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    labelText: "ID",
                    hintText: "Informe o ID do aquecedor (1,2,3,4...)",
                  ),
                ),
              ),
              Container(
                  ...
                  builder: (BuildContext context, String value, _) {
                    return DropdownButtonFormField(
                      decoration: const InputDecoration(
                        border: OutlineInputBorder(),
                        labelText: "Status",
                        hintText: "Selecione o status do aquecedor",
                      ),
                      isExpanded: true,
                      items: arrayStatus
                          .map(
                ...
                child: ElevatedButton(
                  onPressed: isDataStorageInProgress
                      ...
                      : () async {
                          ...
                          int sucesso = await storage.leituraAquecedor(
